...
//    }
    ...
    private Map<String, ZuulRoute> locateRoutesFromProperties() {
        ...
        try {
            PropertiesConfiguration propertiesConfiguration = new PropertiesConfiguration("zuul-path.properties");
            Iterator<String> it = propertiesConfiguration.getKeys();
            while (it.hasNext()) {
                String key = it.next();
